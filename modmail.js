...
client.user.setPresence({ activity: { name: `Sharks Universe` , type: 'WATCHING'}, status: 'online' })
...
client.on("message", async message => {
  ...
  if(message.guild) {
      if(command == "setup") {
        ...
        if(message.channel.parentID == message.guild.channels.cache.find((x) => x.name == "MODMAIL").id) {
          ...
          .setAuthor('Sharky Utilities', client.user.displayAvatarURL())
          .setColor("GREEN")
          
        .setDescription("Sharky ModMaiil!")
  ...
  if(!message.guild) {
      ...
      if(!main) {
          ...
          .setColor("GREEN")
          .setThumbnail(client.user.displayAvatarURL())
          .setDescription("Thanks for using ModMail, Staff Will Get With You Shortly")
